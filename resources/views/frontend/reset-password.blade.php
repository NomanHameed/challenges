...
@section('content')
			...
			<!-- Horizontal Form -->
              ...
              <form  method="post" action="{{ route('admin.reset') }}">
			   ...
			   <input type="hidden" name="token" value="<?php echo @$_GET['token'] ? @$_GET['token'] : Request::old('token'); ?>">

				<div class="input-group mb-3">
					<input type="email" name="email" class="form-control" id="email" placeholder="Email" value="<?php echo @$_GET['email'] ? @$_GET['email'] : Request::old('email'); ?>">
