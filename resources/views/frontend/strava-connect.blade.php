    ...
    <div class="page-body">
        <div class="p-0-30">
            ...
            <div class="dash-inne-main-top">
               ...
               <p>Send daily distance data from your Strava to your challenge(s).</p>
            ...
            <div class="manage-device-wrp">
		        ...
		        <div class="manage-device {{$clsStrava}}">
                    @if($Strava_user)
		            	...
		            	<form action="{{route('frontend.Disconnect')}}" id="disconnect-strava" style="padding: 35px 0;">
			               <button class="theme-btn" style="color: #3c3838 !important;"> Disconnect </button>
			            </form>
			            <a href="https://www.strava.com/login" target="_blank">Your Strava account</a>
		            ...
		            @endif
		            <p style="padding: 35px 0;">Challenge In Motion is designed for use with the Strava platform. This product is not put out by Strava, and Strava does not service or warrant the functionality of this product.</p>
		        </div>
