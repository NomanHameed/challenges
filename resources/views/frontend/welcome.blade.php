						...
						<div class="row 150%">
							<div class="6u 12u$(xsmall)">
								<div class="image fit captioned">
									<img src="{{ asset('frontend/images/pic02.jpg') }}" alt="" />
									<h3>Lorem ipsum dolor sit amet.</h3>
								</div>
							</div>
							<div class="6u$ 12u$(xsmall)">
								<div class="image fit captioned">
									<img src="{{ asset('frontend/images/pic03.png') }}" alt="" />
				...
				<section id="three" class="wrapper style1">
					<div class="container">
						...
						<div class="feature-grid">
							<div class="feature">
								<div class="image rounded"><img src="{{ asset('frontend/images/pic04.jpg') }}" alt="" /></div>
								<div class="content">
									<header>
										<h4>Lorem ipsum</h4>
							...
							<div class="feature">
								<div class="image rounded"><img src="{{ asset('frontend/images/pic05.jpg') }}" alt="" /></div>
								<div class="content">
									<header>
							...
							<div class="feature">
								<div class="image rounded"><img src="{{ asset('frontend/images/pic06.jpg') }}" alt="" /></div>
								<div class="content">
									<header>
							...
							<div class="feature">
								<div class="image rounded"><img src="{{ asset('frontend/images/pic07.jpg') }}" alt="" /></div>
								<div class="content">
									<header>
										<h4>Porro aliquam</h4>
