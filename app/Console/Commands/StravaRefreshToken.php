...
class StravaRefreshToken extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'Strava:Referesh:Token123';
    ...
    public function handle()
    {
        ...
        \Log::info("It is use to generate new Strava access token by refresh token!");
