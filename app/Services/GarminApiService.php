...
class GarminApiService extends Server
{
    /**
     ...
     * @return string
     */
    public function getAuthorizationUrl($temporaryIdentifier, $options = []): string
    {
     ...
     * @throws Exception
     */
    public function backfill(TokenCredentials $tokenCredentials, $uri, array $params): void
    {
        $client = $this->createHttpClient();
        $query = http_build_query($params);
